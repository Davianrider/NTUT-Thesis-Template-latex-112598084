...
\newcommand\cTitle{改善FruityMesh藍牙低功耗網狀網路傳輸效能的設計與實作}

% 我的姓名（中文）
% My Name（Chinese）
\newcommand\myCname{陳柏勳}

% 指導教授的姓名 (中文)，使用頓號隔開 
% Advisor (Chinese), use “、” to separate names
\newcommand\advisorCname{吳和庭 博士}
...
\newcommand\eTitle{Design and Implementation of Performance Enhancements in FruityMesh Based Bluetooth Low Energy Mesh Networks}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{Chen, Po-Hsun}
...
\newcommand\advisorEname{Dr. Wu HO-TING}
